...
\textbf{Baselines.} We compare our system to two baselines Parrotfish and Aquatope. Parrotfish utilizes parametric regression to predict resource configuration, while Aquatope uses Bayesian Optimization to predict resource configuration. We compare our system to these baselines in terms of energy consumption and SLO violations.
